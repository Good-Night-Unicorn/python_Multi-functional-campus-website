<template>
	<div :style='{"alignContent":"flex-start","padding":"0 calc((100% - 1400px)/2)","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","background":"#f6f6f6","display":"flex","width":"100%","fontSize":"16px","position":"relative"}'>
		<div class="section-title" :style='{"padding":"0","margin":"0 auto","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20241026/0662ab9288ed4b258f2abbdfec5cc101.png) no-repeat center 12px","width":"101%","fontSize":"26px","lineHeight":"110px","fontWeight":"500","height":"100px"}'>留言信息</div>
		<div class="back_box">
		...
		<el-form class="add-update-preview" :model="form" :rules="rules" ref="form" label-width="180px">
			...
			<el-form-item :style='{"padding":"0","margin":"20px 0"}'>
				...
				<el-button :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0 24px","margin":"0 20px 0 0","color":"#fff","textAlign":"center","display":"inline-block","minWidth":"120px","borderRadius":"4px","background":"#858585","width":"auto","lineHeight":"44px","fontSize":"16px","height":"44px"}' @click="resetForm('form')">
					<span class="icon iconfont " :style='{"color":"#fff"}'></span>
