	...
	<div>
		...
		<div class="container">
			...
			<el-form class='rgs-form animate__animated animate__' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于DJANGO框架的多功能校园网站的设计与实现</p></div>
					...
					<el-form-item class="list-item" v-if="tableName=='paotui'" prop="paotuizhanghao">
						<div class="label" :class="changeRules('paotuizhanghao')?'required':''">跑腿账号：</div>
						<el-input v-model="registerForm.paotuizhanghao"  placeholder="请输入跑腿账号" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='paotui'" prop="mima">
						<div class="label" :class="changeRules('mima')?'required':''">密码：</div>
						<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='paotui'" prop="mima2">
						<div class="label" :class="changeRules('mima')?'required':''">确认密码：</div>
						<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='paotui'" prop="paotuixingming">
						<div class="label" :class="changeRules('paotuixingming')?'required':''">跑腿姓名：</div>
						<el-input v-model="registerForm.paotuixingming"  placeholder="请输入跑腿姓名" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='paotui'" prop="touxiang">
						<div class="label" :class="changeRules('touxiang')?'required':''">头像：</div>
						<file-upload
							tip="点击上传头像"
							action="file/upload"
					...
					<el-form-item class="list-item" v-if="tableName=='paotui'" prop="xingbie">
						<div class="label" :class="changeRules('xingbie')?'required':''">性别：</div>
						<el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
							<el-option
					...
					<el-form-item class="list-item" v-if="tableName=='paotui'" prop="lianxidianhua">
						<div class="label" :class="changeRules('lianxidianhua')?'required':''">联系电话：</div>
						<el-input v-model="registerForm.lianxidianhua"  placeholder="请输入联系电话" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='paotui'" prop="pquestion">
						<div class="label" :class="changeRules('pquestion')?'required':''">密保问题：</div>
						<el-input v-model="registerForm.pquestion"  placeholder="请输入密保问题" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='paotui'" prop="panswer">
						<div class="label" :class="changeRules('panswer')?'required':''">密保答案：</div>
						<el-input v-model="registerForm.panswer"  placeholder="请输入密保答案" />
					</el-form-item>
					<div class="register-btn">
	...
	mounted() {
		if(this.$route.query.pageFlag=='register'){
			...
			if ('paotui' == this.tableName) {
				...
				this.requiredRules.paotuizhanghao = [{ required: true, message: '请输入跑腿账号', trigger: 'blur' }]
			}
			if ('paotui' == this.tableName) {
				this.rules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }];
				this.requiredRules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }]
			...
			if ('paotui' == this.tableName) {
				...
				this.requiredRules.paotuixingming = [{ required: true, message: '请输入跑腿姓名', trigger: 'blur' }]
			}
		...
		submitForm(formName) {
			this.$refs[formName].validate((valid) => {
				if (valid) {
					...
					if(`paotui` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
						this.$message.error(`两次密码输入不一致`);
						return
					}
