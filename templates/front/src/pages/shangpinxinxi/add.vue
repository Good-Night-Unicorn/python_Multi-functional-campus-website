<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="180px"
			>
			<el-form-item class="add-item" label="商品编码" prop="shangpinbianma">
				<el-input v-model="ruleForm.shangpinbianma" placeholder="商品编码" disabled></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item" label="商品价格" prop="shangpinjiage">
				<el-input-number v-model="ruleForm.shangpinjiage" placeholder="商品价格" :disabled=" false ||ro.shangpinjiage"></el-input-number>
			</el-form-item>
			<el-form-item class="add-item"  label="商品状态" prop="shangpinzhuangtai">
				<el-select v-model="ruleForm.shangpinzhuangtai" placeholder="请选择商品状态" :disabled="true  ||ro.shangpinzhuangtai" >
					<el-option
		...
		methods: {
			...
			init(type) {
				...
				if(type=='cross'){
					...
					for (var o in obj){
						if(o=='shangpinbianma'){
							this.ruleForm.shangpinbianma = obj[o];
							this.ro.shangpinbianma = true;
							continue;
						}
				...
				this.shangpinzhuangtaiOptions = "已出售,未出售".split(',')
			...
			// 提交
			async onSubmit() {
				if(this.ruleForm.shangpinbianma){
					this.ruleForm.shangpinbianma = String(this.ruleForm.shangpinbianma)
				}
