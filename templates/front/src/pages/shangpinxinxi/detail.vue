			...
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						...
						<div class="text "  >{{detail.shangpinbianma}}</div>
					</div>
					<div class="item">
					...
					<div class="item">
						<div class="lable">商品价格</div>
						<div class="text "  >{{detail.shangpinjiage}}</div>
					</div>
					<div class="item">
						<div class="lable">商品状态</div>
						<div class="text "  >{{detail.shangpinzhuangtai}}</div>
					</div>
					<div class="item">
					...
					<div class="btn_box">
						...
						<el-button class="reserveBtn" 
							v-if="btnAuth('shangpinxinxi','购买')" 
							@click="onAcross('shangpingoumai','','','shangpinzhuangtai','已下架','已出售,未出售'.split(',')[0])" type="warning">
							购买
						</el-button>
					</div>
				</div>
