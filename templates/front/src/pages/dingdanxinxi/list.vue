		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.paotuixingming" placeholder="跑腿姓名" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('dingdanxinxi','新增')" type="primary" @click="add('/index/dingdanxinxiAdd')">
...
<script>
	export default {
		...
		async created() {
			...
			this.selectOptionsList.push({name:'发货状态',list:this.fahuozhuangtaiOptions,tableName: 'fahuozhuangtai',check: -1})
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.paotuixingming != '') searchWhere.paotuixingming = '%' + this.formSearch.paotuixingming + '%';
				if (this.formSearch.fahuozhuangtai != '') searchWhere.fahuozhuangtai = this.formSearch.fahuozhuangtai;
