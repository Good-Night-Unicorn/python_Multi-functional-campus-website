	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="购买价格" prop="shangpinjiage" >
					<el-input-number v-model="ruleForm.shangpinjiage" placeholder="购买价格" :disabled="ro.shangpinjiage"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="购买价格" prop="shangpinjiage" >
					<el-input v-model="ruleForm.shangpinjiage" placeholder="购买价格" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'"  label="购买详情" prop="goumaixiangqing" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.goumaixiangqing" label="购买详情" prop="goumaixiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.goumaixiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.goumaixiangqing = this.ruleForm.goumaixiangqing.replace(reg,'../../../django85gv12pu/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
